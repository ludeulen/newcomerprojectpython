...
# 시간이 넘 오래걸려서 jupyter notebook으로 받음
...
#                     param = {
#                         'serviceKey': 'PnDDFfwlwy/ruQHr8wpEN6CJoMvzkuUqorpGhCcvA6a2yajRCSoET2yx4a77oMwDWZ4RtUi1dY55HmVMDle4ig==',
#                         'type': 'json', 'disYear': y, 'disMonth': m, 'cityCode': c, 'page': '1', 'rowNum': '10000'}
#
...
#                     'type': 'json', 'disYear': '2022', 'disMonth': m, 'cityCode': c, 'page': '1', 'rowNum': '10000'}
#
#                 response = requests.get(url, params=param)
#                 result = json.loads(response.text)
#
...
#
#         df_month = pd.concat(list_df)
#         df_month.to_csv('./Data/Food_waste/Food_waste_2022_' + m + '.csv', encoding='cp949')
