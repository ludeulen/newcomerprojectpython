...
def CSI():
    ...
    url = "https://ecos.bok.or.kr/api/StatisticSearch/T8A84YWKZS0PNL81QUGV/json/kr/1/99999/511Y004/M/201501/202210/FMCB"
    response = requests.get(url)
    ...
    # 지역 서울
    url = "https://ecos.bok.or.kr/api/StatisticSearch/T8A84YWKZS0PNL81QUGV/json/kr/1/99999/511Y002/M/201501/202210/FMCA/F0001"
    response = requests.get(url)
    result = json.loads(response.text)
    ...
    url = "https://ecos.bok.or.kr/api/StatisticSearch/T8A84YWKZS0PNL81QUGV/json/kr/1/99999/511Y002/M/201501/202210/FMCB/F0001"
    response = requests.get(url)
